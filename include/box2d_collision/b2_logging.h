...
#define b2Printf(...) b2OutputPrintfVarArgsInternal(__VA_ARGS__)
    ...
    //#define b2Printf(...)
#define b2Warning(...) do{	b2OutputWarningMessageVarArgsInternal("b2Warning[%s,%d]:\n", __FILE__, __LINE__);b2OutputWarningMessageVarArgsInternal(__VA_ARGS__);} while (0)
#define b2Error(...)do	{b2OutputErrorMessageVarArgsInternal("b2Error[%s,%d]:\n", __FILE__, __LINE__);b2OutputErrorMessageVarArgsInternal(__VA_ARGS__);} while (0)
